...
By default development mode enables passwordless logins. If custom SSH keys
are present, passwordless login will no longer be allowed and SSH key access is
enforced.
